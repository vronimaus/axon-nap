...
export default function Wissen() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      <Helmet>
        <title>Wissen - AXON Protocol | Neuroathletik & Faszien</title>
        ...
        <link rel="canonical" href="https://axon-nap.de/Wissen" />
        <meta property="og:title" content="Wissen - AXON Protocol" />
        ...
        <meta name="twitter:title" content="Wissen - AXON Protocol" />
            ...
            {filteredArticles.map((article, idx) => {
              return (
                <motion.div
                  ...
                  onClick={() => window.location.href = createPageUrl(`WissenArtikel?slug=${article.slug}&category=${article.category}`)}
                >
                  {/* Top Bar */}
