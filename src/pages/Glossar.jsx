...
export default function Glossar() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      <Helmet>
        <title>Glossar - AXON Protocol | Fachbegriffe Neuroathletik</title>
        <meta name="description" content="Alle Fachbegriffe aus Neuroathletik, Faszientraining und funktioneller Bewegung einfach erklärt. Das AXON-Glossar für dein Verständnis." />
        <link rel="canonical" href="https://axon-nap.de/Glossar" />
      </Helmet>
