...
/* ─── Data ─────────────────────────────────────────────────────────────────── */
const REGION_MAP = {
  'Nacken/obere Halswirbelsäule': { label: 'Nacken', emoji: '🧠', tag: 'HWS',
  ...
  'Hinterkopf': { label: 'Hinterkopf', emoji: '🧠', tag: 'HWS',
  ...
  'Kopf/Stirn': { label: 'Kopf / Stirn', emoji: '🧠', tag: 'NEU',
  ...
  'Ohr/Kiefergelenk': { label: 'Kiefer (TMJ)', emoji: '🦷', tag: 'TMJ',
  ...
  'Hals vorne': { label: 'Hals vorne', emoji: '🧠', tag: 'HWS',
  ...
  'Schulter vorne/Acromion': { label: 'Schulter', emoji: '💪', tag: 'SHD',
  ...
  'Schulter hinten/Acromion': { label: 'Schulter hinten', emoji: '💪', tag: 'SHD',
  ...
  'Schulterblatt': { label: 'Schulterblatt', emoji: '💪', tag: 'SHD',
  ...
  'oberer Rücken/Nacken': { label: 'Oberer Rücken', emoji: '🔧', tag: 'BWS',
  ...
  'oberer Rücken': { label: 'Rücken oben', emoji: '🔧', tag: 'BWS',
  ...
  'mittlerer Rücken': { label: 'Rücken Mitte', emoji: '🔧', tag: 'BWS',
  ...
  'unterer Rücken/Lendenwirbelsäule': { label: 'LWS / Rücken unten', emoji: '🔧', tag: 'LWS',
  ...
  'Becken/Hüfte': { label: 'Hüfte', emoji: '⚙️', tag: 'HFT',
  ...
  'Gesäß': { label: 'Gesäß / Piriformis', emoji: '⚙️', tag: 'HFT',
  ...
  'Oberschenkel vorne': { label: 'Oberschenkel vorne', emoji: '🦵', tag: 'BNT',
  ...
  'Oberschenkel hinten': { label: 'Oberschenkel hinten', emoji: '🦵', tag: 'BNT',
  ...
  'Knie vorne': { label: 'Knie', emoji: '🦵', tag: 'KNE',
  ...
  'Kniekehle': { label: 'Kniekehle', emoji: '🦵', tag: 'KNE',
  ...
  'Unterschenkel/Schienbein': { label: 'Schienbein', emoji: '🦶', tag: 'FUS',
  ...
  'Fuß/Knöchel vorne': { label: 'Fuß / Knöchel', emoji: '🦶', tag: 'FUS',
  ...
  'Ferse/Achillessehne': { label: 'Achilles / Ferse', emoji: '🦶', tag: 'FUS',
  ...
  'Oberarm': { label: 'Oberarm', emoji: '💪', tag: 'ARM',
  ...
  'Ellenbogen-Beuge': { label: 'Ellenbogen', emoji: '💪', tag: 'ARM',
  ...
  'Ellenbogen': { label: 'Ellenbogen', emoji: '💪', tag: 'ARM',
  ...
  'Unterarm/Handgelenk': { label: 'Unterarm / Handgelenk', emoji: '💪', tag: 'ARM',
  ...
  'obere Brust/Schlüsselbein': { label: 'Brust oben', emoji: '🫁', tag: 'BWS',
  ...
  'mittlere Brust': { label: 'Brust Mitte', emoji: '🫁', tag: 'BWS',
  ...
  'Bauch oben': { label: 'Oberbauch', emoji: '⚙️', tag: 'BWS',
  ...
  'Bauch Mitte/Bauchnabel': { label: 'Bauchmitte', emoji: '⚙️', tag: 'BWS',
  ...
  'Unterbauch/Becken': { label: 'Unterbauch', emoji: '⚙️', tag: 'BKN',
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="text-lg font-black text-white">{regionData.emoji} {regionData.label}</span>
      </div>
...
export default function SystemAuditSection({ onCtaClick }) {
  ...
  const regionData = selectedRegion
    ? (REGION_MAP[selectedRegion] || {
        label: selectedRegion, emoji: '📍', tag: 'NEU',
        root: 'AXON analysiert die kinetische Kette', symptom: selectedRegion, chain: 'Individuelle Kette',
