...
export default function MFRResetScreenDynamic({ onComplete, nodeId = 'N1', screenId = 0, tuneUpData = null }) {
  ...
  useEffect(() => {
    ...
    const testPretest = {
      ...
      'TH-A': 'Strecke beide Arme nach oben über den Kopf. Öffnet sich dein Brustkorb frei? Oder blockiert dich eine Spannung sofort?',
      ...
      'SC-P': 'Schulterblatt-Squeeze: Versuche, deine Schulterblätter zusammenzuziehen. Spannst du leicht an? Oder blockiert dich eine Spannung?',
      ...
      'GE-A': 'Beuge dein Knie langsam. Kommst du tief nach unten? Oder spürst du eine Spannung?',
