  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between px-4 py-3 rounded-xl bg-slate-900/60 border border-cyan-500/20">
        {/* Compact Circle Progress — only in compression step */}
        {step === 'compression' && (
          <div className="relative w-12 h-12 flex items-center justify-center flex-shrink-0 mr-3">
            <svg className="w-full h-full -rotate-90">
              ...
              <motion.circle cx="50%" cy="50%" r="20" fill="none" stroke="currentColor" strokeWidth="2" className="text-emerald-500" strokeDasharray={2 * Math.PI * 20} strokeDashoffset={2 * Math.PI * 20 * (1 - progress / 100)} strokeLinecap="round" />
            </svg>
        ...
        {/* Steps */}
        <div className={step === 'compression' ? '' : 'flex-1'}>
